...
-- Created on Tue Nov 19 10:41:27 2013
-- 
;
--
...
CREATE TABLE "meritcommons_stream" (
  ...
  "type" character varying DEFAULT 'user' NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "meritcommons_stream_type_url_name" UNIQUE ("type", "url_name"),
...
CREATE TABLE "meritcommons_user" (
  ...
  "enc_pub_key" character varying(255),
  "enc_priv_key" character varying(255),
  "sign_pub_key" character varying(255),
  "sign_priv_key" character varying(255),
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "unique_id" UNIQUE ("unique_id"),
