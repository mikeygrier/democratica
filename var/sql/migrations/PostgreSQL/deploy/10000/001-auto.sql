...
-- Created on Tue Jun  7 12:52:03 2016
-- 
;
--
...
;
--
-- Table: meritcommons_keyregistry
--
...
;
--
-- Table: meritcommons_stream_changelog
--
...
;
--
-- Table: meritcommons_stream_message_changelog
--
...
CREATE TABLE "meritcommons_user_meritcommonscointransaction" (
  ...
  "transaction_id" character varying(64) DEFAULT '00000000-0000-0000-DEAD-BEEFDEADBEEF' NOT NULL,
  "meritcommons_user" integer NOT NULL,
  "related_transaction" integer,
  "second_party" integer,
  PRIMARY KEY ("id")
);
CREATE INDEX "txn_type_idx" on "meritcommons_user_meritcommonscointransaction" ("transaction_type");
CREATE INDEX "meritcommonscoin_transaction_user_idx" on "meritcommons_user_meritcommonscointransaction" ("meritcommons_user");
CREATE INDEX "txn_id_idx" on "meritcommons_user_meritcommonscointransaction" ("transaction_id");

;
--
-- Table: meritcommons_user_changelog
--
...
CREATE TABLE "meritcommons_link" (
  ...
  "keywords" text,
  "target" character varying DEFAULT '_blank' NOT NULL,
  "type" character varying,
  "role_policy" character varying DEFAULT 'any' NOT NULL,
  PRIMARY KEY ("id"),
...
CREATE TABLE "meritcommons_stream" (
  ...
  "public_key" text,
  "secret_key" text,
  "show_publicly" integer DEFAULT 0 NOT NULL,
  "display_subscribers" integer DEFAULT 0 NOT NULL,
  "subscriber_count" integer DEFAULT 0 NOT NULL,
  "author_count" integer DEFAULT 0 NOT NULL,
  "moderator_count" integer DEFAULT 0 NOT NULL,
  "members_can_invite" integer DEFAULT 0 NOT NULL,
  "private" integer DEFAULT 0 NOT NULL,
  "membership_requires_moderator_approval" integer DEFAULT 0 NOT NULL,
  "background_image_name" character varying(255),
  "background_image_size" character varying(255),
  "background_image_pretty_size" character varying(255),
  "background_image_content_type" character varying(255),
  "background_image_modify_time" character varying(255),
  "profile_picture_name" character varying(255),
  "profile_picture_size" character varying(255),
  "profile_picture_pretty_size" character varying(255),
  "profile_picture_content_type" character varying(255),
...
;
--
-- Table: meritcommons_user_meritcommonscoinrequest
--
...
;
--
-- Table: meritcommons_user_blockedentity
--
...
;
--
-- Table: meritcommons_file_variant
--
...
CREATE TABLE "meritcommons_stream_message" (
  ...
  "original_body" text,
  "subject" text,
  "nag_interval" integer DEFAULT 0 NOT NULL,
  "submitter_mask" text,
  "body" text NOT NULL,
...
;
--
-- Table: meritcommons_user_identityuser
--
...
;
--
-- Table: meritcommons_user_roleuser
--
...
CREATE TABLE "meritcommons_link_collection_role" (
  ...
  "collection" integer NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "collection_roles" UNIQUE ("role", "collection")
);
