...
package MeritCommons::Model::Stream::Message::Info;

use base qw/DBIx::Class/;
use Carp qw(croak);

__PACKAGE__->load_components(qw/+DBIx::ClassAttachment PK::Auto Core/);
__PACKAGE__->table('meritcommons_stream_message_info');
...
sub sqlt_deploy_hook {
    ...
    $sqlt_table->add_index(
        name   => 'meritcommons_stream_message_info_message_user_idx',
